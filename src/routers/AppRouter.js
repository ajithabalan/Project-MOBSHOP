...
import Creditcard from '../views/checkout/step3/creditcard';
import Payment from 'views/checkout/step3';
import Final from '../views/checkout/step3/final';
...
const AppRouter = () => (
    ...
    <Switch>
        ...
        />
        <ClientRoute
        component={ScrollToTop(Payment)}
        exact
        path="/checkout/step3"
        />
        <ClientRoute
        component={ScrollToTop(Creditcard)}
        exact
        path="/checkout/step3/creditcard"
        />
        <ClientRoute
        component={ScrollToTop(Final)}
        exact
        path="/checkout/step3/creditcard/final"
        />
        <AdminRoute
